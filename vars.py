...
armor_buff_btn = Item(ARMOR_BUFF_BTN_IMAGES,         0,    (800,  700),  scale=1.30)
heal_buff_btn = Item(HEAL_BUFF_BTN_IMAGES,           0,    (1000, 700),  scale=1.30)
speed_buff_btn = Item(SPEED_BUFF_BTN_IMAGES,         0,    (1200, 700),  scale=1.30)
damage_buff_btn = Item(DAMAGE_BUFF_BTN_IMAGES,       0,    (1400, 700),  scale=1.30)
